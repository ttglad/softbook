...
<head>
    ...
    <link href="/{{ $project->project_code }}/css/business-vertical.min.css?v={{ rand(1, 2) }}.{{ rand(0, 9) }}.{{rand(0, 9)}}" rel="stylesheet"/>
</head>
<body>
<div class="page">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
                           aria-label="Open user menu">
                            <span class="avatar avatar-sm" style="background-image: url({{ $project->project_admin_image }})"></span>
                            <div class="d-none d-xl-block ps-2">
                                <div>{{ $project->project_admin }}</div>
...
<script src="/{{$project->project_code}}/js/business.min.js?v={{ rand(1,2) . '.' . rand(0, 20) . '.'.rand(0,20) }}" defer></script>
