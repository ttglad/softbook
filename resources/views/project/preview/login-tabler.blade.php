...
<head>
    ...
    <link href="/tabler/css/tabler.min.css?v={{ rand(1, 2) }}.{{ rand(0, 9) }}.{{rand(0, 9)}}" rel="stylesheet"/>
</head>
<body>
...
<script src="/tabler/js/tabler.min.js?v={{ rand(1, 2) }}.{{ rand(0, 9) }}.{{rand(0, 9)}}" defer></script>
</body>
</html>
