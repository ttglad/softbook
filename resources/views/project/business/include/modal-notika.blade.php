    ...
    <div class="modal-dialog modals-default">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a class="btn btn-link link-secondary" data-dismiss="modal">
                    取消
                </a>
...
<div class="modal fade" id="modal-delete" tabindex="-1" role="dialog" aria-modal="true">
    <div class="modal-dialog modal-sm nk-red">
        <div class="modal-content">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">&times;</button>
            ...
            <div class="modal-footer">
                <a class="btn btn-white w-100" data-dismiss="modal">
                    取消
                </a>
                <a class="btn btn-danger w-100 project-delete-submit" data-dismiss="modal">
                    删除
                </a>
            </div>
        </div>
