...
<head>
    @include('admin.include.header', ['title' => '修改字典类型'])
</head>
<body class="white-bg">
	<div class="wrapper wrapper-content animated fadeInRight ibox-content">
		<form class="form-horizontal m" id="form-dict-edit">
			<input id="dictId" name="dictId"  type="hidden" value="{{ $dict->dict_id }}" />
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input class="form-control" type="text" name="dictType" id="dictType" value="{{ $dict->dict_type }}" required>
