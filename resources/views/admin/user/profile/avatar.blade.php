...
<head>
    @include('admin.include.header', ['title' => '修改用户头像'])

    <link href="/static/ajax/libs/cropper/cropper.min.css?v=1.5.12" rel="stylesheet"/>
...
<script src="/static/ajax/libs/cropper/cropper.min.js?v=1.5.12"></script>
