...
<body class="white-bg">
	<div class="wrapper wrapper-content animated fadeInRight ibox-content">
		<form class="form-horizontal m" id="form-menu-add">
			<input id="treeId" name="parentId" type="hidden" value="{{ $menu['menu_id'] }}" />
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input id="url" name="url" class="form-control" type="text" value="/business/">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
                    @foreach($sysShowList as $type)
                        <div class="radio-box">
                            <input type="radio" id="{{ $type->dict_code }}" name="visible" value="{{ $type->dict_value }}" checked="{{ $type->default }}">
