...
<head>
    @include('admin.include.header', ['title' => '新增菜单'])
</head>
<body class="white-bg">
	<div class="wrapper wrapper-content animated fadeInRight ibox-content">
		<form class="form-horizontal m" id="form-menu-edit">
			<input id="menuId" name="menuId" type="hidden" value="{{ $menu['menu_id'] }}" />
			<input id="treeId" name="parentId" type="hidden" value="{{ $menu['parent_id'] }}" />
			<div class="form-group">
				<label class="col-sm-3 control-label">上级菜单：</label>
				<div class="col-sm-8">
				    <div class="input-group">
						<input class="form-control" type="text" onclick="selectMenuTree()" id="treeName" readonly="true" value="{{ $menu['parent_name'] ?? '无' }}">
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<label class="radio-box"> <input type="radio" name="menuType" value="M" @if(old('menuType', $menu['menu_type']) == "M") checked @endif/> 目录 </label>
					<label class="radio-box"> <input type="radio" name="menuType" value="C" @if(old('menuType', $menu['menu_type']) == "C") checked @endif/> 菜单 </label>
					<label class="radio-box"> <input type="radio" name="menuType" value="F" @if(old('menuType', $menu['menu_type']) == "F") checked @endif/> 按钮 </label>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label is-required">菜单名称：</label>
				<div class="col-sm-8">
					<input class="form-control" type="text" name="menuName" id="menuName" value="{{ old('menuName', $menu['menu_name']) }}" required>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input id="url" name="url" class="form-control" type="text" value="{{ old('url', $menu['url']) }}">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-8">
					<select id="target" name="target" class="form-control m-b">
	                    <option value="menuItem" @if(old('target', $menu['target']) == "menuItem") selected @endif>页签</option>
	                    <option value="menuBlank" @if(old('target', $menu['target']) == "menuBlank") selected @endif>新窗口</option>
	                </select>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input id="perms" name="perms" class="form-control" type="text" value="{{ old('perms', $menu['perms']) }}">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input id="class" name="class" class="form-control" type="text" value="{{ old('class', $menu['class']) }}">
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input class="form-control" type="text" name="orderNum" value="{{ old('orderNum', $menu['order_num']) }}" required>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label" title="单击选择需要使用的FontAwesome图标">图标：<i class="fa fa-question-circle-o"></i></label>
				<div class="col-sm-8">
					<input id="icon" name="icon" class="form-control" type="text" placeholder="选择图标" value="{{ old('icon', $menu['icon']) }}">
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
                    @foreach($sysShowList as $type)
                        <div class="radio-box">
                            <input type="radio" id="{{ $type->dict_code }}" name="visible" value="{{ $type->dict_value }}" @if(old('visible', $menu['visible']) == $type->dict_value) checked @endif>
				...
				<div class="col-sm-3 is-refresh">
				    <div class="radio-box">
						<input type="radio" id="refresh-no" name="isRefresh" value="1" @if(old('isRefresh', $menu['is_refresh']) == 1) checked @endif>
						<label for="refresh-no">否</label>
					</div>
					<div class="radio-box">
						<input type="radio" id="refresh-yes" name="isRefresh" value="0" @if(old('isRefresh', $menu['is_refresh']) == 0) checked @endif>
