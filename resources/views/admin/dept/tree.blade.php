...
<head>
    @include('admin.include.header', ['title' => '部门树选择'])
...
<input id="treeId" name="treeId" type="hidden" value="{{ $dept->dept_id }}"/>
<input id="treeName" name="treeName"  type="hidden" value="{{ $dept->dept_name }}"/>
